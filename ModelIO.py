...
def PredCluster(user_data):
    user_data.rename(columns = {'g':'Gender', 'd':'Drinking',  's':'Smoking'}, inplace = True)
    user_value = user_data['n']
    user_data = user_data.drop(['n'], axis = True)
